...
void GameScene::initInputZones(){
    ...
    _supportZones = {
        {InputController::Action::DROP_ALLY_LEFT,  Rect(-w * 0.149f, h * 0.37f, w * 0.36f, h * 0.55f)},
        {InputController::Action::DROP_ALLY_RIGHT, Rect(w * 0.79f,   h * 0.37f, w * 0.399f, h * 0.55f)},
    };

...
struct AnimationEntry {
    ...
    int loopStartFrame = -1;         /**< If >= 0: play frames 0..loopStartFrame once, then loop the rest (-1 = disabled) */
    int loopEndFrame = -1;           /**< Last frame of the loop range (inclusive). -1 = loop through end of animation */
